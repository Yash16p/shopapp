...
const Footer = () => {
  return (
    <>
      <footer className="w-screen flex flex-wrap mt-5 p-3 z-20" style={{background:"rgba(15, 35, 58, 1)"}}>
        ...
        <div className="lg:w-3/5  p-2 flex justify-center flex-col gap-2 sm:w-screen cursor-pointer">
            <div className="lg:w-4/5  p-5 flex gap-5 justify-center sm:w-screen">
                <h1 className="font-arial text-white text-lg text-nowrap ">NEW ARRIVALS</h1>
                <h1 className="font-arial text-white text-lg text-nowrap">DISCOUNTS</h1>
                <h1 className="font-arial text-white text-lg text-nowrap">CONTACT US</h1>
            </div> 
            ...
            <h4 className="text-white text-xl font-serif text-center ms-14 lg:w-3/5">Ecomzy.Powered By<span className="text-red-400 text-xl ms-1 font-serif font-bold">Mobirisw</span> </h4>
        </div>
